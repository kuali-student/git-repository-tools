 ...
 * 
 * Copied from SVNKit so that we can override the settings as required during the filter.
 * 
 */
public class CustomDumpFilter implements ISVNLoadHandler {
    ...
    private class NodeBaton {
        ...
        void writeProperty(String propName, SVNPropertyValue propValue) throws SVNException {
            CustomDumpFilter.this.writeProperty(myPropertiesBuffer, propName, propValue);
        }
        
        void writeToPropertyBuffer(String data) throws SVNException {
            CustomDumpFilter.this.writeDumpData(myPropertiesBuffer, data);
        }
